...
export default function Footer({ currentYear }: { currentYear: number}) {
    return (
        <div className="flex justify-center items-center w-full h-16 px-4 bg-zinc-50 rounded-md border-2 border-zinc-300">
            <div className="flex flex-col lg:flex-row w-full h-fit">
                <div className="flex justify-center lg:justify-start items-center w-full lg:w-1/2 h-fit gap-1">
